...
urlpatterns = [
    ...
    path('contacto/', core_views.contact, name="contact"),#Mostrara la vista contact
    path('portfolio/', portfolio_views.portfolio, name="portfolio"),#Mostrara la vista portafolio
